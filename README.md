...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8114yfq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8114yfq.containers.anotherwebservice.com/
...
```
git clone git@github.com:DrSlowpokePhd/container-8114yfq.git
cd container-8114yfq
```
...
```
docker attach container-8114yfq
```
